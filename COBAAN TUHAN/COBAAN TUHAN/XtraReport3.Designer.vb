...
Partial Public Class XtraReport3
    ...
    Private Sub InitializeComponent()
        ...
        'SqlDataSource1
        '
        Me.SqlDataSource1.ConnectionName = "localhost_restaurant_Connection 3"
        Me.SqlDataSource1.Name = "SqlDataSource1"
        CustomSqlQuery1.Name = "Query"
        CustomSqlQuery1.Sql = "select menu_name, sum(amount) from menu m, dselling d where m.menu_id=d.menu_id g" &
    "roup by menu_name;"
    ...
    "T0ibWVudV9uYW1lIiBUeXBlPSJTdHJpbmciIC8+PEZpZWxkIE5hbWU9InN1bShhbW91bnQpIiBUeXBlP" &
    "SJEZWNpbWFsIiAvPjwvVmlldz48L0RhdGFTZXQ+"
        ...
        Me.label1.Text = "Amount Menu Bought"
        '
        'GroupHeader1
        '
        ...
        Me.tableCell1.Text = "menu name"
        Me.tableCell1.Weight = 0.47296269343449521R
        '
        'tableCell2
        '
        ...
        Me.tableCell2.Text = "Berapa Kali dibeli"
        Me.tableCell2.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        Me.tableCell2.Weight = 0.52703725961538461R
        '
        'Detail
        '
        ...
        Me.tableCell3.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() {New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[menu_name]")})
        Me.tableCell3.Name = "tableCell3"
        Me.tableCell3.StyleName = "DetailData1"
        Me.tableCell3.StylePriority.UseBorders = False
        Me.tableCell3.Weight = 0.47296269343449521R
        '
        'tableCell4
        '
        Me.tableCell4.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() {New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[sum(amount)]")})
        ...
        Me.tableCell4.TextFormatString = "{0:0}"
        Me.tableCell4.Weight = 0.52703730656550485R
        '
        'XtraReport3
        '
